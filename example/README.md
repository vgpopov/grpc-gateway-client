...
The client is generated by [grpc-gateway-client](https://github.com/vgpopov/grpc-gateway-client) that provides a clean typed interface to interact with the gRPC service over REST API:
